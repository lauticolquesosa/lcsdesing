...
(function () {
  ...
  const PROJECTS = {
    ...
    p16: {
      year: '2026', url: 'paraviciniarquitectura.vercel.app', full: ['paravicini-fullpage.webp'], tools: ['Figma', 'HTML / CSS', 'JavaScript'],
      es: { cat: 'Diseño Web + UX/UI', title: 'Paravicini Arquitectura', role: 'LCS · Diseño & Desarrollo Web', client: 'Estudio Paravicini · San Lorenzo Chico, Salta',
        problem: 'El estudio Paravicini diseña y construye casas de autor en Salta y Tucumán desde 2006, y además lleva dos líneas paralelas —desarrollos inmobiliarios propios y venta y alquiler de propiedades— a cargo de distintos miembros de la familia. Todo eso, sumado a los pedidos de quienes quieren construir en Salta sin poder viajar, se mezclaba sin un canal propio que lo ordenara.',
        goal: 'Construir un sitio que muestre la obra construida como prueba, explique el proceso remoto paso a paso para quien no puede visitar Salta, y separe con claridad las tres líneas del estudio sin que ninguna tape a las demás.',
        steps: [['01','Descubrir','Las tres audiencias del estudio: quien construye, quien invierte y quien compra'],['02','Definir','Arquitectura, Desarrollos y Propiedades como tres puertas separadas'],['03','Diseñar','Dirección editorial cálida, con foto real de obra construida'],['04','Entregar','Sitio responsive con proceso a distancia y WhatsApp directo']],
        result: 'Sitio en vivo con seis obras construidas en Salta y Tucumán mostradas con foto, ubicación y año (Casa San Lorenzo Chico 2023, Casa Patio de Adobe 2022, Casa Galería 2021, Refugio en el Cerro 2024, Casa Miradores 2023, Taller Paravicini 2020), el proceso a distancia explicado en cuatro pasos para quien no puede viajar a Salta —primer encuentro por videollamada, anteproyecto con vistas 3D, proyecto ejecutivo y documentación, acompañamiento de obra a distancia—, y las dos líneas satélite, Paravicini Desarrollos y Paravicini Propiedades, cada una con su responsable a la vista y su propio acceso.',
        learn: 'Un estudio familiar con tres negocios corre el riesgo de que ninguno se entienda del todo. Separar arquitectura, desarrollos y propiedades en tres puertas —cada una con su responsable visible— dejó que la obra construida siguiera siendo el argumento principal, y el resto, una consecuencia.' },
      en: { cat: 'Web Design + UX/UI', title: 'Paravicini Arquitectura', role: 'LCS · Web Design & Development', client: 'Estudio Paravicini · San Lorenzo Chico, Salta',
        problem: 'Estudio Paravicini has designed and built author-driven houses in Salta and Tucumán since 2006, and also runs two parallel lines — private real-estate developments and property sales and rentals — led by different family members. All of that, plus enquiries from people who want to build in Salta without being able to visit, blended together with no channel of its own to sort it out.',
        goal: 'Build a site that shows built work as proof, explains the remote process step by step for clients who cannot visit Salta, and clearly separates the studio\'s three lines without any one crowding out the others.',
        steps: [['01','Discover','The studio\'s three audiences: who builds, who invests and who buys'],['02','Define','Architecture, Developments and Properties as three separate doors'],['03','Design','Warm editorial direction with real built-work photography'],['04','Deliver','Responsive site with the remote process and direct WhatsApp']],
        result: 'A live site with six built projects across Salta and Tucumán shown with photo, location and year (Casa San Lorenzo Chico 2023, Casa Patio de Adobe 2022, Casa Galería 2021, Refugio en el Cerro 2024, Casa Miradores 2023, Taller Paravicini 2020), the remote process explained in four steps for clients who cannot travel to Salta — first video call, pre-project with 3D views, executive project and documentation, remote site-visit follow-up —, and the two satellite lines, Paravicini Desarrollos and Paravicini Propiedades, each with its lead named up front and its own entry point.',
        learn: 'A family studio running three businesses risks having none of them fully understood. Splitting architecture, developments and properties into three doors — each with a visible lead — let the built work stay the main argument, with everything else as a consequence.' }
    }
  };
