...
(function () {
  ...
  const PROJECTS = {
    ...
    p13: {
      year: '2026', url: 'lacondesa-one.vercel.app', full: ['lacondesa-fullpage-v2.webp'], tools: ['Figma', 'HTML / CSS', 'JavaScript'],
      es: { cat: 'Diseño Web + UX/UI', title: 'La Condesa', role: 'LCS · Diseño & Desarrollo Web', client: 'La Condesa · Medicina estética · Bucaramanga, Colombia',
        problem: 'La Condesa es un centro de medicina estética facial y corporal en Bucaramanga, con más de 11.700 pacientes siguiéndolas. Ofrece diez tratamientos muy distintos entre sí —de botox y plasma rico en plaquetas a moldeo corporal y postoperatorios— y además dicta capacitaciones. Todo eso llegaba mezclado por Instagram: la paciente no sabía qué procedimiento le correspondía ni por dónde empezar a preguntar.',
        goal: 'Ordenar el catálogo en dos áreas claras (facial y corporal) para que cada persona reconozca su tratamiento y reserve por WhatsApp, sin pasar por una consulta previa solo para entender la oferta.',
        steps: [['01','Descubrir','Qué busca la paciente y con qué palabras nombra su problema'],['02','Definir','Dos bloques: estética facial y estética corporal, cinco tratamientos cada uno'],['03','Diseñar','Sistema dorado y sobrio, con foto real de procedimiento'],['04','Entregar','Sitio responsive con reserva por WhatsApp en cada tratamiento']],
        result: 'Sitio en vivo con los diez tratamientos separados en dos áreas y con su propio botón de reserva, tres argumentos de confianza (atención personalizada, resultados naturales, bioseguridad certificada), carrusel de trabajos reales, bloque de capacitaciones para profesionales, y horarios y ubicación junto al Hospital Universitario.',
        learn: 'En estética, la paciente no busca "un tratamiento": busca resolver algo puntual. Poner un botón de reserva en cada procedimiento, y no uno solo al final, acortó el camino de la duda al mensaje.' },
      en: { cat: 'Web Design + UX/UI', title: 'La Condesa', role: 'LCS · Web Design & Development', client: 'La Condesa · Aesthetic medicine · Bucaramanga, Colombia',
        problem: 'La Condesa is a facial and body aesthetic medicine centre in Bucaramanga, with over 11,700 patients following them. It offers ten very different treatments — from botox and platelet-rich plasma to body contouring and post-op care — and also runs training courses. All of it arrived mixed together via Instagram: patients could not tell which procedure applied to them or where to start asking.',
        goal: 'Organize the catalogue into two clear areas (facial and body) so each person recognizes their treatment and books over WhatsApp, without needing a consultation just to understand the offer.',
        steps: [['01','Discover','What patients look for and the words they use for their concern'],['02','Define','Two blocks: facial and body aesthetics, five treatments each'],['03','Design','Sober gold system with real procedure photography'],['04','Deliver','Responsive site with WhatsApp booking on every treatment']],
        result: 'Live site with ten treatments split across two areas, each with its own booking button, three trust arguments (personalized care, natural results, certified biosafety), a carousel of real work, a training block for professionals, and hours and location next to the University Hospital.',
        learn: 'In aesthetics, patients are not looking for "a treatment": they want a specific concern solved. Putting a booking button on every procedure, rather than one at the end, shortened the path from doubt to message.' }
    },
    p14: {
