...
(function () {
  ...
  const PROJECTS = {
    ...
    p18: {
      year: '2026', url: 'jmsconstructora.vercel.app', full: ['jms-fullpage.webp'], tools: ['Figma', 'Next.js', 'React'],
      es: { cat: 'Diseño Web', title: 'JMS Constructora', role: 'LCS · Diseño & Desarrollo Web', client: 'JMS Constructora · La Plata, Buenos Aires',
        problem: 'JMS construye en La Plata desde hace más de treinta años y tiene nueve mil personas siguiendo su trabajo en Instagram, pero ahí las obras se mezclan con el día a día y desaparecen al mes siguiente. Quien quería cotizar una casa, una reforma o un desarrollo entero no tenía dónde ver la trayectoria junta ni cómo empezar una conversación que no fuera un mensaje suelto.',
        goal: 'Reunir treinta años de obra en una sola página que se lea de arriba abajo, mostrar los cuatro tipos de trabajo que toman y dejar una sola acción posible al final de cada bloque: escribir por WhatsApp.',
        steps: [['01','Descubrir','Qué le preguntan antes de contratar: alcance, tiempos y quién dirige'],['02','Definir','Una sola página larga en cinco capítulos numerados'],['03','Diseñar','Negro, verde y tipografía cursiva para el remate de cada titular'],['04','Entregar','Landing responsive con WhatsApp fijo y obras reales']],
        result: 'Landing en vivo hecha en Next.js, de una sola página en cinco capítulos numerados. Abre con las dos cifras que sostienen el argumento —más de 30 años construyendo y 9K+ personas siguiendo el trabajo— sobre la foto de Casa JMS; sigue con los cuatro servicios (proyecto y construcción, viviendas, desarrollos, y reformas e interiores), cuatro obras seleccionadas con su estado a la vista (Casa JMS terminada, el desarrollo Aires del Pinar, AMICS II en ejecución y Cocinas JMS), el proceso en cuatro pasos, un bloque de trayectoria y tres preguntas frecuentes. Todos los botones, y uno fijo abajo a la derecha, van al mismo WhatsApp.',
        learn: 'Una constructora con treinta años no necesita explicar su método: necesita mostrar obra y hacer fácil el primer mensaje. Por eso el sitio es una sola página y no un menú: cada capítulo termina en el mismo lugar, y el visitante nunca tiene que decidir dónde hacer clic para preguntar.' },
      en: { cat: 'Web Design', title: 'JMS Constructora', role: 'LCS · Web Design & Development', client: 'JMS Constructora · La Plata, Buenos Aires',
        problem: 'JMS has been building in La Plata for over thirty years and has nine thousand people following its work on Instagram, but there the projects blend into everyday posts and vanish a month later. Anyone wanting a quote for a house, a renovation or a full development had nowhere to see the track record in one place, and no way to start a conversation beyond a stray message.',
        goal: 'Gather thirty years of work into a single page that reads top to bottom, show the four kinds of job they take on, and leave one possible action at the end of every block: message them on WhatsApp.',
        steps: [['01','Discover','What clients ask before hiring: scope, timing and who runs the site'],['02','Define','One long page in five numbered chapters'],['03','Design','Black, green and an italic face to close every headline'],['04','Deliver','Responsive landing with a fixed WhatsApp button and real projects']],
        result: 'A live landing page built in Next.js, one page in five numbered chapters. It opens with the two figures that carry the argument — over 30 years building and 9K+ people following the work — over a photo of Casa JMS; then four services (design and build, homes, developments, and renovations and interiors), four selected projects with their status on show (Casa JMS completed, the Aires del Pinar development, AMICS II under construction and Cocinas JMS), the four-step process, a track-record block and three FAQs. Every button, plus a fixed one in the bottom corner, goes to the same WhatsApp line.',
        learn: 'A builder with thirty years behind them does not need to explain its method: it needs to show work and make the first message easy. That is why the site is a single page and not a menu — every chapter ends in the same place, and the visitor never has to decide where to click to ask.' }
    },
    p19: {
